...
> **Note:** No `--gpu` flag needed. Recording-only mode doesn't use the GPU.
...
See [Recording & Storage](recording-storage.md) for full details.
...
> ⚠️ This will fail if no `WHISPER_LIVE_URL` is configured or reachable.
